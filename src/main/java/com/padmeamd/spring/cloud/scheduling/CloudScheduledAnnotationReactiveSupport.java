...
/**
 * Helper class for @{@link CloudScheduledAnnotationBeanPostProcessor} to support reactive
 ...
 * @since 6.1
 */
abstract class CloudScheduledAnnotationReactiveSupport {

	static final boolean REACTOR_PRESENT = ClassUtils.isPresent(
			"reactor.core.publisher.Flux", CloudScheduledAnnotationReactiveSupport.class.getClassLoader());

	static final boolean COROUTINES_REACTOR_PRESENT = ClassUtils.isPresent(
			"kotlinx.coroutines.reactor.MonoKt", CloudScheduledAnnotationReactiveSupport.class.getClassLoader());

	private static final Log logger = LogFactory.getLog(CloudScheduledAnnotationReactiveSupport.class);
	 ...
	 */
	public static Runnable createSubscriptionRunnable(Method method, Object targetBean, CloudScheduled scheduled,
